...
parser.add_argument('--model.x_dim', type=str, default='3,64,64', metavar='XDIM',
...
parser.add_argument('--train.learning_rate', type=float, default=5e-4, metavar='LR',
                    help='learning rate (default: 0.0001)')
parser.add_argument('--train.decay_every', type=int, default=500, metavar='LRDECAY',
